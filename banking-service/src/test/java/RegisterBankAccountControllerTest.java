...
import com.likipay.banking.BankingApplication;
import com.likipay.banking.adapter.in.web.RegistereBankAccountRequest;
...
public class RegisterBankAccountControllerTest {
  ...
  void testRegisterBankAccount() throws Exception {
    ...
    RegistereBankAccountRequest req = new RegistereBankAccountRequest("1", "토스뱅크", "1010", true);
